import '../Home/home.achievement.style.scss'
...
const HomeAchievement = () => {
  return (
    <div className='home__achievement' >
                <img src='img\12.png' />
                <img src='img\14.png' />
                <div className='home__achievement_content'>
                    <p>Các thành tựu của công ty</p>
                    {/* <small>Since 1987 established fact that a reader will <br />
                        be distracted by the readable content of a page <br />
                        when looking at its layout.</small> */}
